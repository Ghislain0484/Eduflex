				...
				children: [/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(13,148,136,0.08),transparent_50%)]" }), /* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("p", {
							...
							children: "EduFlex+ offre aux établissements, universités, entreprises et formateurs d'Afrique de l'Ouest et Centrale la possibilité d'héberger leurs formations sous leur propre marque avec paiement Mobile Money intégré."
						}),
						/* @__PURE__ */ jsxs("div", {
						...
						/* @__PURE__ */ jsx(Card, {
							...
							children: /* @__PURE__ */ jsxs(CardContent, {
								...
								children: [
									...
									/* @__PURE__ */ jsx("h3", {
										className: "font-bold text-white text-lg",
										children: "Classes Virtuelles Jitsi"
									}),
									/* @__PURE__ */ jsx("p", {
										className: "text-xs text-slate-400 leading-relaxed",
							...
							children: [
								...
								/* @__PURE__ */ jsxs("ul", {
									...
									children: [
										...
										/* @__PURE__ */ jsxs("li", {
											className: "flex items-center gap-2",
											children: [/* @__PURE__ */ jsx(CheckCircle, { className: "h-4 w-4 text-teal-500 shrink-0" }), " Jitsi Live (jusqu'à 50 participants)"]
										}),
										/* @__PURE__ */ jsxs("li", {
											className: "flex items-center gap-2",
							...
							children: [
								...
								/* @__PURE__ */ jsxs("ul", {
									...
									children: [
										...
										/* @__PURE__ */ jsxs("li", {
											className: "flex items-center gap-2",
											children: [/* @__PURE__ */ jsx(CheckCircle, { className: "h-4 w-4 text-teal-500 shrink-0" }), " Jitsi Live illimité avec support direct"]
										}),
										/* @__PURE__ */ jsxs("li", {
											className: "flex items-center gap-2",
											children: [/* @__PURE__ */ jsx(CheckCircle, { className: "h-4 w-4 text-teal-500 shrink-0" }), " Intégration du standard de modules SCORM"]
										}),
										/* @__PURE__ */ jsxs("li", {
											className: "flex items-center gap-2",
											children: [/* @__PURE__ */ jsx(CheckCircle, { className: "h-4 w-4 text-teal-500 shrink-0" }), " Panel d'administration multi-comptes"]
										}),
										/* @__PURE__ */ jsxs("li", {
											className: "flex items-center gap-2",
											children: [/* @__PURE__ */ jsx(CheckCircle, { className: "h-4 w-4 text-teal-500 shrink-0" }), " Support premium prioritaire 24/7"]
										})
									]
								}),
								/* @__PURE__ */ jsx(Button, {
