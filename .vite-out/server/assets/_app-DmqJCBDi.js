				...
				children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs(Tooltip, { children: [/* @__PURE__ */ jsx(TooltipTrigger, {
							...
							className: "absolute right-0 mt-2 w-72 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-2xl p-4 text-left space-y-3 z-50 animate-in fade-in zoom-in-95 duration-150",
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: /* @__PURE__ */ jsxs("div", {
									className: "p-2.5 bg-slate-50 dark:bg-slate-950/60 rounded-lg border border-slate-200 dark:border-slate-800 space-y-0.5",
					...
					/* @__PURE__ */ jsxs(Tooltip, { children: [/* @__PURE__ */ jsx(TooltipTrigger, {
						...
						children: /* @__PURE__ */ jsx(Button, {
							...
							children: /* @__PURE__ */ jsx(Link, {
								to: "/courses",
								children: /* @__PURE__ */ jsx(GraduationCap, { className: "h-4.5 w-4.5 text-teal-500 dark:text-teal-400" })
							})
						})
					}), /* @__PURE__ */ jsx(TooltipContent, {
						side: "bottom",
							...
							children: [
								/* @__PURE__ */ jsx(Avatar, {
									...
									children: /* @__PURE__ */ jsx(AvatarFallback, {
										className: "text-[11px] font-bold bg-teal-500/10 text-teal-500 dark:text-teal-400",
										children: initials
									})
								}),
								/* @__PURE__ */ jsx("span", {
									className: "text-xs font-bold text-slate-800 dark:text-slate-200 hidden sm:inline-block max-w-[120px] truncate",
...
function NavItem({ item, collapsed }) {
	...
	const link = /* @__PURE__ */ jsxs("div", {
		className: "w-full",
		children: [item.subItems ? /* @__PURE__ */ jsxs("button", {
			type: "button",
			onClick: toggleSub,
			className: cn("flex items-center gap-2.5 rounded-md text-sm transition-colors cursor-pointer w-full text-left", collapsed ? "justify-center w-8 h-8 mx-auto" : "px-3 py-2 w-full", isActive || open ? "bg-primary/10 text-primary font-semibold" : "text-muted-foreground hover:bg-accent hover:text-foreground"),
			children: [/* @__PURE__ */ jsx("span", {
				className: "shrink-0",
				children: item.icon
				...
				children: [/* @__PURE__ */ jsx("span", { children: item.label }), /* @__PURE__ */ jsxs("span", {
					...
					children: [item.badge && /* @__PURE__ */ jsx("span", {
						...
						children: item.badge
					}), open ? /* @__PURE__ */ jsx(ChevronDown, { className: "h-3.5 w-3.5 opacity-70" }) : /* @__PURE__ */ jsx(ChevronRight, { className: "h-3.5 w-3.5 opacity-70" })]
				})]
			})]
		}) : /* @__PURE__ */ jsxs(Link, {
			to: item.href,
			className: cn("flex items-center gap-2.5 rounded-md text-sm transition-colors cursor-pointer", collapsed ? "justify-center w-8 h-8 mx-auto" : "px-3 py-2 w-full", isActive ? "bg-primary/10 text-primary font-semibold" : "text-muted-foreground hover:bg-accent hover:text-foreground"),
			children: [/* @__PURE__ */ jsx("span", {
				className: "shrink-0",
				children: item.icon
			}), !collapsed && /* @__PURE__ */ jsxs("span", {
				className: "truncate flex-1 flex items-center justify-between",
				children: [/* @__PURE__ */ jsx("span", { children: item.label }), item.badge && /* @__PURE__ */ jsx("span", {
					className: "text-[9px] font-extrabold bg-red-500/10 text-red-500 border border-red-500/20 px-1.5 py-0.5 rounded-full uppercase tracking-tighter",
					children: item.badge
				})]
			})]
...
function AppSidebarShell() {
	...
	useEffect(() => {
		...
		else if (theme === "light" && isDark) root.classList.remove("dark");
...
function useBrandTheme(colorOverride) {
	useEffect(() => {
		...
		if (styleElement.getAttribute("data-color") !== brandColor) {
...
function SharedAppLayout({ appName = "EduFlex", sidebar = /* @__PURE__ */ jsx(AppSidebarShell, {}), children }) {
	...
	if (!(isAuthenticated || typeof window !== "undefined" && Object.keys(localStorage).some((k) => k.includes("sb-") && k.includes("-auth-token")))) return /* @__PURE__ */ jsx(SharedLayoutContext.Provider, {
		value,
		children: /* @__PURE__ */ jsxs("div", {
